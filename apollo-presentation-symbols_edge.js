...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'cardFlow_symbol',
            type:'rect',
            rect:['-10','-285','auto','auto','auto','auto']
         },
         {
            id:'baseball-full',
            display:'none',
...
"cardFlow": {
   ...
   dom: [
   {
      rect: ['10px','304px','640px','1065px','auto','auto'],
      id: 'coverFlow',
      transform: [[],[],[],['1','1.03714']],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid12940", tween: [ "style", "${_liverpoolGameGroup}", "z-index", '35', { fromValue: '50'}], position: 4900, duration: 1000, easing: "easeOutCubic" },
            ...
            { id: "eid12947", tween: [ "style", "${_liverpoolGameGroup}", "top", '166px', { fromValue: '4px'}], position: 3800, duration: 1000, easing: "easeOutCubic" },
            { id: "eid12941", tween: [ "style", "${_liverpoolGameGroup}", "top", '-387px', { fromValue: '166px'}], position: 4800, duration: 600, easing: "easeOutCubic" },
            { id: "eid12942", tween: [ "style", "${_liverpoolGameGroup}", "top", '87px', { fromValue: '-387px'}], position: 5400, duration: 500, easing: "easeOutCubic" },
            ...
            { id: "eid13117", tween: [ "style", "${_Rectangle}", "display", 'none', { fromValue: 'block'}], position: 4900, duration: 0, easing: "easeOutCubic" },
            ...
            { id: "eid13162", tween: [ "style", "${_natsGameGroupCopy}", "top", '-594px', { fromValue: '40px'}], position: 3800, duration: 500, easing: "easeOutCubic" },
            { id: "eid13163", tween: [ "style", "${_natsGameGroupCopy}", "top", '-46px', { fromValue: '-594px'}], position: 4300, duration: 500, easing: "easeOutCubic" },
            { id: "eid13185", tween: [ "style", "${_natsGameGroupCopy}", "top", '124px', { fromValue: '-46px'}], position: 4800, duration: 1100, easing: "easeOutCubic" },
            { id: "eid13165", tween: [ "style", "${_natsGameGroupCopy}", "z-index", '25', { fromValue: '50'}], position: 3800, duration: 500, easing: "easeOutCubic" },
            { id: "eid13191", tween: [ "style", "${_natsGameGroupCopy}", "z-index", '50', { fromValue: '25'}], position: 4900, duration: 500, easing: "easeOutCubic" },
            ...
            { id: "eid13174", tween: [ "style", "${_Baseball-normal-colorCopy3}", "opacity", '0', { fromValue: '1'}], position: 3800, duration: 1000 },
            { id: "eid13193", tween: [ "style", "${_Baseball-normal-colorCopy3}", "opacity", '1', { fromValue: '0'}], position: 4900, duration: 1000 },
            ...
            { id: "eid13169", tween: [ "style", "${_RectangleCopy3}", "display", 'block', { fromValue: 'block'}], position: 4800, duration: 0, easing: "easeOutCubic" },
            { id: "eid13170", tween: [ "style", "${_RectangleCopy3}", "display", 'block', { fromValue: 'block'}], position: 4900, duration: 0, easing: "easeOutCubic" },
            { id: "eid13171", tween: [ "style", "${_RectangleCopy3}", "display", 'none', { fromValue: 'block'}], position: 5400, duration: 0, easing: "easeOutCubic" },
            ...
            { id: "eid13071", tween: [ "style", "${_RectangleCopy}", "display", 'block', { fromValue: 'block'}], position: 4800, duration: 0, easing: "easeOutCubic" },
            ...
            { id: "eid13172", tween: [ "style", "${_RectangleCopy3}", "opacity", '0', { fromValue: '0'}], position: 5120, duration: 0, easing: "easeOutCubic" },
            ...
            { id: "eid12944", tween: [ "style", "${_natsGameGroup}", "top", '36px', { fromValue: '-594px'}], position: 4300, duration: 500, easing: "easeOutCubic" },
            { id: "eid13187", tween: [ "style", "${_natsGameGroup}", "top", '-437px', { fromValue: '116px'}], position: 4800, duration: 600, easing: "easeOutCubic" },
            { id: "eid13188", tween: [ "style", "${_natsGameGroup}", "top", '-46px', { fromValue: '-437px'}], position: 5400, duration: 500, easing: "easeOutCubic" },
            { id: "eid13113", tween: [ "style", "${_RectangleCopy}", "opacity", '0', { fromValue: '0'}], position: 5120, duration: 0, easing: "easeOutCubic" },
