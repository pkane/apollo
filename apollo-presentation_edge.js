   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid13154", tween: [ "style", "${_offEdgeNav}", "display", 'block', { fromValue: 'block'}], position: 17100, duration: 0 },
            { id: "eid13155", tween: [ "style", "${_offEdgeNav}", "display", 'block', { fromValue: 'block'}], position: 17600, duration: 0 },
            ...
            { id: "eid13117", tween: [ "style", "${_Rectangle}", "display", 'none', { fromValue: 'block'}], position: 4800, duration: 0, easing: "easeOutCubic" },
            { id: "eid13119", tween: [ "style", "${_Rectangle}", "display", 'block', { fromValue: 'none'}], position: 5400, duration: 0, easing: "easeOutCubic" },
            { id: "eid13118", tween: [ "style", "${_Rectangle}", "display", 'block', { fromValue: 'block'}], position: 5900, duration: 0, easing: "easeOutCubic" },
            ...
            { id: "eid13149", tween: [ "style", "${_offEdgeNav}", "left", '-4px', { fromValue: '-538px'}], position: 16200, duration: 500 },
            { id: "eid13151", tween: [ "style", "${_offEdgeNav}", "left", '-538px', { fromValue: '-4px'}], position: 17100, duration: 500 },
